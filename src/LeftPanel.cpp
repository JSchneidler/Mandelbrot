...
LeftPanel::LeftPanel(wxPanel* parent, const uint16_t height)
	...
	, real_input(new wxTextCtrl(this, wxID_ANY, wxString::Format(wxT("%f"), DEFAULT_CENTER.getReal()), wxPoint(10, 80), wxSize(75, -1)))
	, imaginary_label(new wxStaticText(this, wxID_ANY, wxT("Center Imaginary"), wxPoint(10, 110)))
	, imaginary_input(new wxTextCtrl(this, wxID_ANY, wxString::Format(wxT("%f"), DEFAULT_CENTER.getImaginary()), wxPoint(10, 130), wxSize(75, -1)))
...
void LeftPanel::OnSetParameters(wxCommandEvent& event)
{
	...
	ComplexNumber center = ComplexNumber{ wxAtof(real_input->GetValue()), wxAtof(imaginary_input->GetValue()) };
